# Doesnt delete the [Content Types].xml file, need to investigate
# Parameters - fill these in before running the script!
# =====================================================

$FilePath = "C:\Users\Tom\Documents\PBI projects\AdventureWorksDW.pbix"    # the path of the file you are changing
$TempPath = "C:\Temp"   # Temp file location for file storage
$NewFileName = "AdventureWorksDW2" #New name for edited file
$NewBackgroundPath = "C:\Users\Tom\Documents\PBI projects\Background2019.png" 
